...
:precondition (and (token p_5) (tracePointer ev14))
:effect (and (allowed) (not (token p_5)) (token p_6) (not (tracePointer ev14)) (tracePointer evEND))
)
...
:precondition (and (token p_12) (tracePointer ev12))
:effect (and (allowed) (not (token p_12)) (token p_14) (not (tracePointer ev12)) (tracePointer ev13))
)

(:action moveSync#store_results#ev13
:precondition (and (token p_12) (tracePointer ev13))
:effect (and (allowed) (not (token p_12)) (token p_14) (not (tracePointer ev13)) (tracePointer ev14))
)
...
:precondition (and (token p_4) (tracePointer ev8))
:effect (and (allowed) (not (token p_4)) (token p_5) (not (tracePointer ev8)) (tracePointer ev9))
)

(:action moveSync#launch_algorithm#ev9
:precondition (and (token p_4) (tracePointer ev9))
:effect (and (allowed) (not (token p_4)) (token p_5) (not (tracePointer ev9)) (tracePointer ev10))
)
