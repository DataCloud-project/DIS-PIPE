...
(:action moveSync#endanalysis#ev13
...
(:action moveSync#event12end#ev14
:precondition (and (token p_13) (tracePointer ev14))
:effect (and (allowed) (not (token p_13)) (token sink) (not (tracePointer ev14)) (tracePointer evEND))
)
