...
(:action moveSync#event12end#ev3
:precondition (and (token source) (tracePointer ev3))
:effect (and (allowed) (not (token source)) (token p_3) (not (tracePointer ev3)) (tracePointer evEND))
)
...
(:action moveSync#endanalysis#ev2
