...
(:action moveSync#receivescalemeasure#ev2
...
:precondition (and (token p_11) (tracePointer ev16))
:effect (and (allowed) (not (token p_11)) (token p_13) (not (tracePointer ev16)) (tracePointer ev17))
)
...
:precondition (and (token p_13) (tracePointer ev17))
:effect (and (allowed) (not (token p_13)) (token sink) (not (tracePointer ev17)) (tracePointer evEND))
)
...
(:action moveInTheLog#receivescalemeasure#ev2-ev3
