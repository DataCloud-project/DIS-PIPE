...
:precondition (and (token p_3) (tracePointer ev6))
:effect (and (allowed) (not (token p_3)) (token p_4) (not (tracePointer ev6)) (tracePointer ev7))
)
...
:effect (and (allowed) (not (token p_4)) (token p_5) (not (tracePointer ev12)) (tracePointer evEND))
)
...
:precondition (and (token p_11) (tracePointer ev11))
:effect (and (allowed) (not (token p_11)) (token p_13) (not (tracePointer ev11)) (tracePointer ev12))
)
