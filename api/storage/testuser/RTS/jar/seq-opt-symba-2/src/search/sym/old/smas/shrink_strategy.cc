...
bool ShrinkStrategy::must_shrink(
    const SymbolicAbstraction &abs, int threshold, bool force) const {
    assert(threshold >= 1);
...
void ShrinkStrategy::shrink_atomic(SymbolicAbstraction & /*abs*/) {
    // Default implemention does nothing.
}

void ShrinkStrategy::shrink_before_merge(SymbolicAbstraction &abs1, SymbolicAbstraction &abs2) {
