...
(:action moveSync#endanalysis#ev8
:precondition (and (token p_11) (tracePointer ev8))
:effect (and (allowed) (not (token p_11)) (token p_13) (not (tracePointer ev8)) (tracePointer ev9))
)
...
(:action moveSync#event12end#ev9
:precondition (and (token p_13) (tracePointer ev9))
:effect (and (allowed) (not (token p_13)) (token sink) (not (tracePointer ev9)) (tracePointer evEND))
)
