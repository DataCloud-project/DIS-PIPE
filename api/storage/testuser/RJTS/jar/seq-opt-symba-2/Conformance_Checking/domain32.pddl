...
(:action moveSync#endanalysis#ev9
:precondition (and (token p_11) (tracePointer ev9))
:effect (and (allowed) (not (token p_11)) (token p_13) (not (tracePointer ev9)) (tracePointer ev10))
)
...
(:action moveSync#event12end#ev10
:precondition (and (token p_13) (tracePointer ev10))
:effect (and (allowed) (not (token p_13)) (token sink) (not (tracePointer ev10)) (tracePointer evEND))
)
