...
(:action moveSync#endanalysis#ev11
...
(:action moveSync#event12end#ev12
:precondition (and (token p_13) (tracePointer ev12))
:effect (and (allowed) (not (token p_13)) (token sink) (not (tracePointer ev12)) (tracePointer evEND))
)
