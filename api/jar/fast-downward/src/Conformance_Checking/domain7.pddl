...
(:action moveSync#data_merge#ev6
:precondition (and (token source) (tracePointer ev6))
:effect (and (allowed) (not (token source)) (token p_3) (not (tracePointer ev6)) (tracePointer ev7))
)

(:action moveSync#data_merge#ev7
...
:precondition (and (token p_13) (tracePointer ev4))
:effect (and (allowed) (not (token p_13)) (token p_14) (not (tracePointer ev4)) (tracePointer ev5))
)

(:action moveSync#trasformation#ev5
:precondition (and (token p_13) (tracePointer ev5))
:effect (and (allowed) (not (token p_13)) (token p_14) (not (tracePointer ev5)) (tracePointer ev6))
)
...
:precondition (and (token p_14) (tracePointer ev8))
:effect (and (allowed) (not (token p_14)) (token sink) (not (tracePointer ev8)) (tracePointer ev9))
)

(:action moveSync#visualization#ev9
:precondition (and (token p_14) (tracePointer ev9))
:effect (and (allowed) (not (token p_14)) (token sink) (not (tracePointer ev9)) (tracePointer ev10))
)
...
:precondition (and (token p_5) (tracePointer ev2))
:effect (and (allowed) (not (token p_5)) (token p_6) (not (tracePointer ev2)) (tracePointer ev3))
)

(:action moveSync#query#ev3
:precondition (and (token p_5) (tracePointer ev3))
:effect (and (allowed) (not (token p_5)) (token p_6) (not (tracePointer ev3)) (tracePointer ev4))
)
...
(:action moveSync#report_generated#ev10
:precondition (and (token p_6) (tracePointer ev10))
:effect (and (allowed) (not (token p_6)) (token p_7) (not (tracePointer ev10)) (tracePointer evEND))
)
...
:effect (and (allowed) (not (token p_11)) (token p_10) (not (tracePointer ev2)) (tracePointer ev3))
)

(:action moveSync#query#ev3
:precondition (and (token p_11) (tracePointer ev3))
:effect (and (allowed) (not (token p_11)) (token p_10) (not (tracePointer ev3)) (tracePointer ev4))
)
...
(:action moveInTheLog#report_generated#ev10-evEND
:precondition (and (tracePointer ev10) (allowed))
:effect (and (not (tracePointer ev10)) (tracePointer evEND) (increase (total-cost) 1)
))
