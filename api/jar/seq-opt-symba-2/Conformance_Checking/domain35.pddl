...
(:action moveSync#analyzedata#ev10
...
:precondition (and (token p_10) (tracePointer ev11))
:effect (and (allowed) (not (token p_10)) (token p_11) (not (tracePointer ev11)) (tracePointer ev12))
)

(:action moveSync#analyzedata#ev12
:precondition (and (token p_10) (tracePointer ev12))
:effect (and (allowed) (not (token p_10)) (token p_11) (not (tracePointer ev12)) (tracePointer ev13))
)

(:action moveSync#analyzedata#ev13
:precondition (and (token p_10) (tracePointer ev13))
:effect (and (allowed) (not (token p_10)) (token p_11) (not (tracePointer ev13)) (tracePointer ev14))
)

(:action moveSync#analyzedata#ev14
...
(:action moveSync#analyzedata#ev15
:precondition (and (token p_10) (tracePointer ev15))
:effect (and (allowed) (not (token p_10)) (token p_11) (not (tracePointer ev15)) (tracePointer ev16))
)

(:action moveSync#analyzedata#ev16
...
(:action moveSync#endanalysis#ev17
:precondition (and (token p_11) (tracePointer ev17))
:effect (and (allowed) (not (token p_11)) (token p_13) (not (tracePointer ev17)) (tracePointer ev18))
)
...
(:action moveSync#event12end#ev18
:precondition (and (token p_13) (tracePointer ev18))
:effect (and (allowed) (not (token p_13)) (token sink) (not (tracePointer ev18)) (tracePointer evEND))
)
...
(:action moveInTheLog#analyzedata#ev10-ev11
