...
## Requirements
The code has been tested using **Python 3.8.12** and **conda 4.10.3**. Other versions are not guaranteed to work properly. At the moment, DIS-PIPE can be deployed correctly on Windows and Linux operating systems. 
